      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
         <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div className="flex items-end justify-between mt-2">
                <span className="text-2xl font-bold text-slate-900">R$ {stats.revenue.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
         ...
         <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div className="flex items-end justify-between mt-2">
                <span className="text-2xl font-bold text-slate-900">R$ {stats.expenses.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
