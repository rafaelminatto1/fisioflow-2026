...
import { BellIcon, PlusIcon, ListIcon, SunIcon, BrainCircuitIcon, CheckCircleIcon, AlertCircleIcon, WalletIcon, CalendarIcon, XIcon, CheckIcon } from './Icons';
...
const Header: React.FC<HeaderProps> = ({ currentPage, onMenuClick }) => {
  ...
  const getTitle = () => {
      switch(currentPage) {
          ...
          case 'agenda': return 'Gestão de Agenda';
          case 'patients': return 'Centro de Pacientes';
          case 'financial': return 'Fluxo Financeiro';
          case 'analysis': return 'Análise Biométrica';
          case 'telemedicine': return 'Telemedicina';
          case 'crm': return 'CRM & Vendas';
          default: return 'FisioFlow v3.0';
      }
  };
