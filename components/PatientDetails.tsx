                                ...
                                <div key={session.id} className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm relative group">
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <div className="flex items-center gap-2 mr-12">
                                            ...
                                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold text-white shadow-sm ${session.evaScore > 7 ? 'bg-red-500' : session.evaScore > 3 ? 'bg-amber-500' : 'bg-emerald-500'
                                                }`}>
                                                {session.evaScore}
                                            </div>
                                        </div>
